tl24 <- read_experimental_data("../data/results_tl.txt", subj_offset = 1000, item_offset = 1000)

tl24 %<>% mutate(exp_condition = case_when(
...
tl24.clean$grammatical %<>% dplyr::recode(gram = "grammatical", ungram = "ungrammatical")
