...
languages presents an unclear picture. For instance,
\citet{FrankEtAl2010} used French and compared the unambiguously
accusative marked attractors to NPs with no overt case marking. They
showed that when unambiguous marking increased the attraction effects
substantially, contrary to the predictions of cue based retrieval.
Similarly, \citet{AvetisyanEtAl:2020} also demonstrated that unambiguous
case marking in Armenian did not affect neither reading times nor
attraction errors.
