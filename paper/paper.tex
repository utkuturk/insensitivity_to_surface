...
when heuristics suﬀice, creating the opportunity for surface
...
happens to occur in Turkish. Turkish uses the same surface suﬀix,
...
\citep{HammerlyEtAl2019, Turk2022}. To assess whether the absence of
...
and comprehension questions can bleed into dependency resolution. A
recent work by \citet{Slioussar2018} argued that an accidental
...
cues seems to be gatekeeped by being a possible controller in other
relevant work in syncretism.
...
prior work shows that even pseudoplural nouns fail to attract
\citep{BockEberhard1993, HaskellMacDonald2003, NicolEtAl:2016}. We
...
agreement in other constructions (e.g., in relative clauses), thus
passing this abstract gate. Our Turkish verbal attractors, by contrast,
...
morphology that is sometimes associated with subjects or agreement
controllers {[}\citet{LagoEtAl2019}; \citet{BhatiaDillon2022};
\citet{BleotuDillon2024}; {]}. In other words, it is not form overlap
