...
gloss_example("The key to the cabinets are rusty.")
```
:::
...
::: {.content-visible when-format="html"}
```{r, echo=FALSE, results='asis'}
gloss_example("The key to the cabinets is rusty.")
```
:::
...
gloss_example(
  "Die Stellungnahme zu den Demonstration-en",
  "the.F.NOM.SG position on the.F.DAT.PL demonstration-PL",
...
gloss_example(
  "Korobka dlya kraski byla/*byli ...",
  "box.F.SG.NOM for paint.GEN.SG=NOM.PL be.PST.F.SG/*be.PST.F.PL",
  "‘A box for the paint(s) was/*were …’"
)
gloss_example(
  "Korobka dlya krasok byla/*byli ...",
  "box.F.SG.NOM for paint.GEN.PL≠NOM.PL be.PST.F.SG/*be.PST.F.PL",
  "‘A box for the paint(s) was/*were …’"
)
```
:::
