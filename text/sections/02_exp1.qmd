...
m.exp1.all <- brm(
  brms::bf(response_yes ~ grammatical * attractor_num * att_type +
        (1 + grammatical * attractor_num * att_type | subject) +
        (1 + grammatical * attractor_num * att_type | item), 
     decomp = "QR"), # Keep QR decomposition; it helps immensely with convergence here
  data = exp1.all,
  ...
  cores = 4,                         # Run all 4 chains at the exact same time
  threads = threading(threads = 14), # 14 threads per chain (4 x 14 = 56 cores used)
  iter = 12000,                      
  warmup = 2000,                     
  init = 0, 
  file = "../../utility/models/m.exp1.all.yes",
  seed = 25022026
)
